...
\cventry{2023, 6 months}{Research data scientist}{\href{https://reuniwatt.com/en}{Reuniwatt}}{Saint-Pierre}{France}{\begin{itemize}
    ...
    \item Worked in an agile team, contributing to sprint planning and agile development.
    \end{itemize}}
...
\cvitem{Sports}{Trail-running (ultramarathon), cycling, soccer (10 years, played in an academy).}
